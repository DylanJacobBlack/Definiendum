...
SimpleForm.setup do |config|
  ...
  config.button_class = 'text-lg py-2 px-3 hover:bg-yellow-400 bg-yellow-500 text-black hover:text-black rounded transition duration-200 shadow-md cursor-pointer'
